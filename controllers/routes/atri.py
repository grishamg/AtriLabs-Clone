...
class Atri:
	def __init__(self, state: Any):
		...
		self.navbar_title = state["navbar_title"]
	...
	def navbar_title(self):
		self._getter_access_tracker["navbar_title"] = {}
		return self._navbar_title
	@navbar_title.setter
	def navbar_title(self, new_state):
		self._setter_access_tracker["navbar_title"] = {}
		global default_state
		self._navbar_title = Flex(new_state, default_state["navbar_title"])
	...
	def _to_json_fields(self):
		return {
			...
			"navbar_title": self._navbar_title,
